---
title: Brooks Range to Kaktovik
date: '2026-06-27'
excerpt: |
...
coordinates:
  - start: -144.61,69.1
  - end: -143.6,70.1
trackingUrl: 'https://share.garmin.com/KXR2Y'
itinerary:
  - id: grassers-strip
    name: Grasser's Strip
    dates: July 2nd
    coordinates:
      - -144.608
      - 69.105
    zoom: 11
    pitch: 50
    image: /images/brooks-range-hulahula/1.grassers.webp
    ...
    routePoints:
      ...
      - - -144.114
        - 69.098
  - id: okpiliak
    name: Exploring the Okpilak glacier
    dates: July 3rd
    coordinates:
      - -144.136465
      - 69.141243
    zoom: 12
    pitch: 40
    image: /images/brooks-range-hulahula/2.okpilak.webp
    description: Moving up hill, we'll wander up and over the glacier, towards the divide, and then back down to the headwaters.
    routePoints:
      - - -144.232692
        - 69.130321
      - - -144.357361
  ...
  - id: hulahula-canyon
    ...
    zoom: 11
    pitch: 55
    image: /images/brooks-range-hulahula/3.canyon.webp
  ...
  - id: old-man
    ...
    zoom: 11
    pitch: 35
    image: /images/brooks-range-hulahula/4.hotsprings.webp
    description: As we approach the coastal plain, we have a chance to climb up and over the range and descend back to the Okpilak river. Here there is robust geothermic activity, and hotsprings mix with the snowmelt flowing down from the Okpilak river. If our timing works, we'll stop and camp a night at these hotsprings.
    routePoints:
      - - -144.035678
        - 69.330376
      - - -144.035717
  ...
  - id: coastal-plain
    ...
    zoom: 10
    pitch: 20
    image: /images/brooks-range-hulahula/5.coastal.webp
    description: The last section flattens out onto the long coastal plain. Hard paddling might be required, as the headwinds come off the sea, and the water slows. We'll navigate the mudflats, and camp upriver away from the sea one last night.
    routePoints:
      - - -143.745706
        - 69.853731
      - - -143.825399
  ...
  - id: arey-lagoon
    ...
    zoom: 11
    pitch: 10
    image: /images/brooks-range-hulahula/6.lagoon.webp
    description: In the morning, we'll catch a channel into the Arey Lagoon, and hug the coast, carefully navigating the sea ice still visible on the 10m sat images. We'll camp somewhere near the final crossing to Barter Island and Kaktovik.
    routePoints:
      - - -143.830742
        - 70.086575
      - - -143.729833
  ...
  - id: kaktovik
    ...
    zoom: 13
    pitch: 0
    image: /images/brooks-range-hulahula/7.barter.webp
...
<iframe
  src="https://share.garmin.com/KXR2Y"
  width="100%"
  height="100%"
  frameborder="0"
  title="Live Garmin tracking"
  style="display: block;"
></iframe>
</div>
...
We're using 1:63,360-scale USGS quads — the standard for Alaska backcountry. The route crosses three map series. 

### Mount Michelson (headwaters, Brooks Range crossing)

| Quad | Download |
|------|----------|
| A-1 | [Mount_Michelson_A-1.pdf](/topos/Mount_Michelson_A-1.pdf) |
| A-2 | [Mount_Michelson_A-2.pdf](/topos/Mount_Michelson_A-2.pdf) |
| B-1 | [Mount_Michelson_B-1.pdf](/topos/Mount_Michelson_B-1.pdf) |
| C-1 | [Mount_Michelson_C-1.pdf](/topos/Mount_Michelson_C-1.pdf) |
| D-1 | [Mount_Michelson_D-1.pdf](/topos/Mount_Michelson_D-1.pdf) |

### Flaxman Island & Barter Island (coast, Kaktovik)

| Quad | Download |
|------|----------|
| Flaxman Island A-1 | [Flaxman_Island_A-1.pdf](/topos/Flaxman_Island_A-1.pdf) |
| Barter Island A-5 | [Barter_Island_A-5.pdf](/topos/Barter_Island_A-5.pdf) |
...
- iPhone
- Compass
- Printed paper quads for critical sections

**Packraft**
- Alpacka Raft Gnarwal packraft + paddle
- Kokatat drysuit
- PFD + Knife
- Dry bags (40L + 20L per person)

**Clothing**
- Merino base layers (top + bottom)
- Hardshell jacket + pants
- Lightweight down puffy
- Midlayer pants
- Wool socks × 4
- Neoprene booties (for river days)
...
- First aid kit
- Blister kit
- Ibuprofen, Benadryl, antibiotics
- Water filter

**Misc**
- Sunscreen SPF 50
- Bug head net + Ultrathon
- Repair tape (Tenacious Tape, duct tape, Aquaseal)
- Packraft repair kit
- Lighter
- Toilet Paper
...
*Photos from the trip will appear here.*
